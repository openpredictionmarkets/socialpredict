    ...
    return (
        <div className="App">
            ...
            <div className="left-content">
                ...
                <h5>Efficiency through Community Engagement</h5>
                ...
                <h5>Domain-Specific Prediction Markets</h5>
                ...
                <h3>Join us in shaping the future of prediction markets by building connections and expertise within your community.</h3>
            </div>
            <div> </div>
            <div> </div>
            <div> .</div>
