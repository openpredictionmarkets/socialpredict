...
function Create() {
    ...
    const handleSubmit = async (event) => {
        ...
        if (resolutionDateTime) {
            ...
            if (!isNaN(dateTime.getTime())) { // Check if the date object is valid
    ...
    return (
        ...
        <div className="App">
            <div className="Center-content-header"><h1>Create a Market</h1></div>
        ...
        <form onSubmit={handleSubmit} className="create-form">
            ...
            <div>
                <label>
                    ...
                    <input type="datetime-local" value={resolutionDateTime} onChange={(e) => setResolutionDateTime(e.target.value)} />
                </label>
            </div>
