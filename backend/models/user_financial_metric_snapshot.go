...
type UserFinancialMetricSnapshot struct {
	...
	UnrealizedWorkIncome  int64     `json:"unrealizedWorkIncome" gorm:"not null;default:0"`
	UnrealizedWorkProfits int64     `json:"unrealizedWorkProfits" gorm:"not null;default:0"`
