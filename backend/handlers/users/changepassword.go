...
// ChangePasswordHandler returns an HTTP handler that delegates password changes to the auth service.
func ChangePasswordHandler(auth authsvc.Authenticator) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err := auth.ChangePassword(r.Context(), user.Username, req.CurrentPassword, req.NewPassword); err != nil {
