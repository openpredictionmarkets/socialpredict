...
func ProjectNewProbabilityHandler(mcl setup.MarketCreationLoader) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		projectedProbability := wpam.ProjectNewProbabilityWPAM(mcl, marketCreatedAt, currentBets, newBet)
