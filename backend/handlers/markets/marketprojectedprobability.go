...
func ProjectNewProbabilityHandler(loadEconomicsConfig setup.EconConfigLoader) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		projectedProbability := wpam.ProjectNewProbabilityWPAM(loadEconomicsConfig, marketCreatedAt, currentBets, newBet)
