...
13. **Multiple-Choice Binary Markets** - [`FEATURES/13/13-multiple-choice-binary-markets.md`](./FEATURES/13/13-multiple-choice-binary-markets.md), [`FEATURES/13/DESIGN.md`](./FEATURES/13/DESIGN.md), [`FEATURES/13/PLAN.md`](./FEATURES/13/PLAN.md)
14. **Grouped Market Transaction Boundaries** - [`FEATURES/14/14-grouped-market-transaction-boundaries.md`](./FEATURES/14/14-grouped-market-transaction-boundaries.md), [`FEATURES/14/DESIGN.md`](./FEATURES/14/DESIGN.md), [`FEATURES/14/PLAN.md`](./FEATURES/14/PLAN.md)
15. **Grouped Discovery Read Model Pagination** - [`FEATURES/15/15-grouped-discovery-read-model-pagination.md`](./FEATURES/15/15-grouped-discovery-read-model-pagination.md), [`FEATURES/15/DESIGN.md`](./FEATURES/15/DESIGN.md), [`FEATURES/15/PLAN.md`](./FEATURES/15/PLAN.md)
16. **Grouped Discovery Cache Invalidation** - [`FEATURES/16/16-grouped-discovery-cache-invalidation.md`](./FEATURES/16/16-grouped-discovery-cache-invalidation.md), [`FEATURES/16/DESIGN.md`](./FEATURES/16/DESIGN.md), [`FEATURES/16/PLAN.md`](./FEATURES/16/PLAN.md)
17. **Grouped Activity Freshness Metadata** - [`FEATURES/17/17-grouped-activity-freshness-metadata.md`](./FEATURES/17/17-grouped-activity-freshness-metadata.md), [`FEATURES/17/DESIGN.md`](./FEATURES/17/DESIGN.md), [`FEATURES/17/PLAN.md`](./FEATURES/17/PLAN.md)
18. **Grouped Answer Limit Contract Alignment** - [`FEATURES/18/18-grouped-answer-limit-contract-alignment.md`](./FEATURES/18/18-grouped-answer-limit-contract-alignment.md), [`FEATURES/18/DESIGN.md`](./FEATURES/18/DESIGN.md), [`FEATURES/18/PLAN.md`](./FEATURES/18/PLAN.md)
