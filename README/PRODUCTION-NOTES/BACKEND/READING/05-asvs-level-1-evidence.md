...
| Transaction-sensitive accounting | Partial | Place-bet and sell-position have explicit transaction seams in current PR stack history. | Market resolution transaction/concurrency policy still needs a dedicated slice. |
