...
6) **Maintain OpenAPI docs** in `backend/docs/` (`openapi.yaml` plus `README.md`).
...
backend/docs/openapi.yaml (canonical OpenAPI 3.0.3 contract)

backend/docs/README.md (overview, publishing notes, and deferred API follow-ups)
...
OpenAPI source of truth exists in backend/docs/openapi.yaml, with human overview in backend/docs/README.md.
